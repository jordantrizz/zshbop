...
default_tools=('mosh' 'traceroute' 'mtr' 'pwgen' 'tree' 'ncdu' 'fpart' 'whois' 'pwgen' 'python3-pip' 'joe' 'keychain' 'dnsutils' 'whois' 'gh' 'php-cli' 'telnet' 'lynx' )
extra_tools=('pip' 'npm')
...
init () {
	...
	source $ZSH_ROOT/help.zshrc
        ...
        source $ZSH_ROOT/cmds/commands.zshrc # Available commands
